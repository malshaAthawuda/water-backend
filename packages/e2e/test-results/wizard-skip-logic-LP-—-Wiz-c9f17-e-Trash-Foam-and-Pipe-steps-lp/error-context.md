...
- Name: lp/wizard-skip-logic.spec.js >> LP — Wizard: Skip Logic by Water Source >> Borehole — should skip Algae, Trash, Foam, and Pipe steps
- Location: tests/lp/wizard-skip-logic.spec.js:205:3
...
Call log:
  - waiting for getByRole('heading', { name: 'oil' }).first() to be visible
