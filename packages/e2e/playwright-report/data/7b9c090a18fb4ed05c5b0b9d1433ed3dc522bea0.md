...
- Name: lp/wizard-welcome.spec.js >> LP — Wizard Welcome Step (NIC entry & report check) >> should accept new-format NIC (12 digits)
- Location: tests/lp/wizard-welcome.spec.js:62:3
...
Call log:
  - navigating to "http://localhost:5174/report", waiting until "load"
